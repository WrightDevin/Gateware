...
The \hyperlink{class_g_w_1_1_c_o_r_e_1_1_g_broadcasting}{G\+Broadcasting} Interface is capable of registering \& deregistering \hyperlink{class_g_w_1_1_c_o_r_e_1_1_g_listener}{G\+Listener} interfaces. The Broadcaster must then notifiy any listeners of advertised events via the \char`\"{}\+G\+Listener\+::\+On\+Event\char`\"{} callback During registration a \hyperlink{class_g_w_1_1_c_o_r_e_1_1_g_broadcasting}{G\+Broadcasting} implmenetation may choose to support filtration via bitflags (optional) 
